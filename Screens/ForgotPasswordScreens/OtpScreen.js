            ...
            <View style={styles.screen}>
                ...
                <View style={styles.container}>
                    ...
                    <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'center', marginTop: 30 }}>
                        <Text style={{ color: AppColors.infoFonts, fontFamily: "Poppins-Regular", fontSize: 13 }}>Don’t get it? </Text>
                        <TouchableOpacity style={{ alignItems: 'center', justifyContent: 'center', marginStart: -20 }}>
                            <Text style={[styles.inputHeader, { fontSize: 13 }]}>Resend code</Text>
                        </TouchableOpacity>
                    </View>
                </View>
            </View>
